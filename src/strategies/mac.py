...
class MovingAverageCrossStrategy(Strategy):
    ...
    windows are 100/4000 periods respectively.
    """
...
if __name__ == "__main__":
    csv_dir = r'/Users/lindazhong/Documents/Code/PycharmProjects/QuantTrade/Event_Driven_Engine/historical data'
    symbol_list = ['AAPL']
    ...
    plt.plot(backtest.portfolio.equity_curve["equity_curve"])
    plt.show()

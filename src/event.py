...
class FillEvent(Event):
    ...
    def __init__(self, timeindex, symbol, exchange, quantity,
        ...
        exchange, quantity, direction, cost of fill and an
        optional commission. If commission is not provided,
        the Fill object will calculate it based on the trade
        size and Interactive Brokers fees.
